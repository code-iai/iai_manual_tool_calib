...
class ToolCalib(object):
    def __init__(self):
        ...
        self.tool_marker.header.frame_id = "l_gripper_tool_frame"
        ...
        self.tool_marker.mesh_resource = "package://iai_manual_tool_calib/meshes/servingspoon_bremen.dae"
    ...
    def create_6dof_marker(self):
        ...
        imarker.header.frame_id = "l_gripper_tool_frame"
    ...
    def marker_callback(self, data):
        if data.event_type == InteractiveMarkerFeedback.MOUSE_UP:
            rospy.loginfo("received interactive marker update")
